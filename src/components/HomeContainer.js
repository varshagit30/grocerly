    ...
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 gap-2 " id="home">
            <div className="py-2 flex-1 flex-col items-start md:items-center justify-start">
                ...
                <p className="text-[2.5rem] font-bold lg:text-[4.5rem] tracking-wide text-black ">
                ...
                px-14 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 md:w-auto"
                >
                   {" "} Order Now
                </button>
            </div>
            ...
            <div className=" py-2 flex-1 flex items-center">
                <div className="w-full flex items-center justify-center relative">
                    ...
                    <div className="w-full h-full absolute top-0 left-0 flex items-top justify-center py-1 ">
                        <div className="w-180 p-14 bg-slate-200 backdrop-blur">
